...
Ideate. Innovate. Build!";
	  ...
	  <link href="https://fonts.googleapis.com/css?family=Coustard|Fanwood+Text|Marcellus" rel="stylesheet">
...
"> <a href="#"><img src="https://i.imgur.com/NSBCfAX.png" style="height: 80%;margin-top: 4px;"></a></p>
	  ...
	  <div class="paget vision" style="text-align:center">
            <div id="vision" class=" right-stop left-stop " style="text-align:center">
               ...
               <br>
               <p class="vasan" style="text-align:justify ; font-family: 'Marcellus', serif;">
         ...
         <div class='paget' style="background-color: #181A1C !important">
            <div class='sectiont featuret-1'>
               ...
               <div>
                  <p style="text-align: center ; font-family: 'Marcellus', serif;">Put on your Imagination Hats! </p>
               </div>
            </div>
            <div class='sectiont featuret-2'>
               ...
               <div>
                  <p style="text-align: center ;font-family: 'Marcellus', serif;">Explore hidden potentials!</p>
               </div>
            </div>
            <div class='sectiont featuret-3'>
               ...
               <div>
                  <p style="text-align: center ; font-family: 'Marcellus', serif;">Pick up your Magic Wands!</p>
               </div>
            </div>
         </div>
		...
		<div class="container-fluid ">
            ...
            <div class='application'>
               <div id='about' class="col-md-8">
                  <h1 style="  color: white ; font-family: 'Archivo Black', sans-serif
                     " >ABOUT US</h1>
                  <p  style="text-align:justify ; font-family: 'Marcellus', serif;">
                    ...
                    <div class="carousel-inner text-center">
                        ...
                        <div class="item">
                            <blockquote>
                                <div class="row">
                                    <div class="col-sm-10 col-sm-offset-1">
                                        <p style="padding-left:30px ; font-family: 'Zilla Slab', serif;">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. .</p>
