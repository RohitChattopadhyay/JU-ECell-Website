...
-->
	...
	<div id="status">&nbsp;</div>
        ...
        <button class="md-trigger" data-modal="modal-11" id="thank-you-modal-button" style="display:none"></button>
...
?>
	...
	<button class="md-trigger" data-modal="modal-12" id="web-modal-button" style="display:none"></button>
            ...
            <div class="cards">
                ...
                <div class="card card-1">
                    ...
                    <div class="card-body">
                        ...
                        <p style="text-align: center"><a target="_blank" href="https://events.joshtalks.com/kolkata18/" class="btn btn-lg btn-primary detail-button">Details</a></p>
                    </div>
                </div>
